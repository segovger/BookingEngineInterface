                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <p style="margin: 0;">Su traslado a nombre de <strong>$name $lastname</strong> ha sido registrado.</p>
                                    <p style="margin: 0;">La camioneta partirá de $Origen en dirección a $Destino en la fecha: <strong>$Fecha</strong> <span style="font-size: 0.8em;">(MM/DD/YYYY)</span> a las <strong>$Horario:00</strong></p>
                                </td>
                            </tr>
							<tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <p style="margin: 0; color: #333333;">Precio total: $precioTraslado </p>
									<p style="margin: 0; color: #333333;">Pago de reserva: $precioReserva  (PAGADO)</p>
									<p style="margin: 0; color: #333333;">Pago pendiente (pagar en efectivo al chofer): $pagoPendiente </p>
                                </td>
                            </tr>
                            <!--<tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                            ...
                            <tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <p style="margin: 0; color: #333333;">Nombres de Pasajeros: $nombresPasajeros</p>
                                    <p style="margin: 0; color: #333333;">Dirección de recogida: $origenExacto</p>
                                    <p style="margin: 0; color: #333333;">Dirección de destino: $destinoExacto</p>
                                    <p style="margin: 0; color: #333333;">Asientos para bebé: $asientosBebe</p>
                                    <p style="margin: 0; color: #333333;">Número de asientos de bebé: $numAsientosBebe</p>
