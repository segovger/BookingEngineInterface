                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style="margin: 0 0 10px 0; font-family: 'Work Sans', sans-serif; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">Nuevo traslado registrado</h1>
                                    <p style="margin: 0;">Traslado a nombre de <strong>$name $lastname</strong></p>
                                    <p style="margin: 0;">Traslado de: $Origen a $Destino durante la fecha: $Fecha <span style="font-size: 0.8em;">(MM/DD/YYYY)</span>, en el horario $Horario:00</p>
                                </td>
                            </tr>
							<tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                            ...
                            <tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style="margin: 0 0 10px 0; font-family: 'Work Sans', sans-serif; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">Origen en Cancún</h1>
