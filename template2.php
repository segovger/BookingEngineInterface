                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <p style="margin: 0;">Traslado a nombre de $name $lastname</p>
                                    <p style="margin: 0;">Traslado de: $Origen a $Destino durante la fecha: $Fecha <span style="font-size: 0.8em;">(MM/DD/YYYY)</span>, en el horario $Horario</p>
                                </td>
                            </tr>
							<tr>
                                <td style="padding: 20px; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                        <tr>
                                            <td class="button-td button-td-primary" style="border-radius: 4px; background: #222222;">
											     <a class="button-a button-a-primary" href="http://localhost:8888/Booking_Engine/cust.php" style="background: #399F9D; font-family: 'Work Sans', sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;">Más Información</a>
											</td>
                                        </tr>
                                    </table>
									<br />
