    ...
    <div class="hero is-fullheight">
        <div class="hero-body">
            <div class="container">
                    ...
                    <div class="column">
                     <h1 class="has-text-centered title is-1"><?php echo $lang['transaction_error_title'] ?></h1>
                     <hr>
                     <p class="has-text-centered"><?php echo $lang['transaction_error_desc'] ?></p>
                     <br />
                     <div class="has-text-centered"><a href="booking.php" class="button"><?php echo $lang['transaction_error_cta'] ?></a></div>
                     <br />
                </div>
            </div>
        </div>
